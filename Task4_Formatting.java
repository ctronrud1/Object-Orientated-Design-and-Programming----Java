// ************************************************************ 
// File Name: Task4_Formatting
// Author: Charlie Tronrud
// Purpose:	Computes the cost of buying an item at the deli.
// ************************************************************ 
import java.util.Scanner;
import java.text.NumberFormat;
import java.text.DecimalFormat;

public class Task4_Formatting {
    // ---------------------------------------------------
    ...
    public static void main(String[] args) {
        ...
        // Formatt for the weight in pounds and money for the prices
